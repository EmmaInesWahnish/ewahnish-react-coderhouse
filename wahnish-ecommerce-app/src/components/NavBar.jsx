  ...
  return (
    <div className="d-flex justify-content-between align-items-center bg-warning py-2">
      <nav id="barraNavegacion" className="navbar navbar-expand-sm bg-warning asBody px-5 m-0">
        <div id="brand">
          <a id="logo" className="pointer navbar-brand-bg bg-warning logo"><i className="fas fa-utensils"></i></a>
        </div>
      ...
      <a className="pointer nav-link asBody px-5 cart" id="confirmar"><CartWidget /></a>
    </div>
  );
}
